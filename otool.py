...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', action='store_true', help='Print the fat headers')
    parser.add_argument('-a', action='store_true', help='Print the archive header')
    parser.add_argument('-h', action='store_true', help='Print the mach header')
    parser.add_argument('-l', action='store_true', help='Print the load commands')
